        ...
        return (
            <div className="col-12">
                <a className="col-12 play-button" href={"/playgame/?x-access-token=" + getToken()} target="_blank" rel="noopener noreferrer">
                    <img className="button-menu-image" src="/website/images/launch.jpg" alt="launch" />
                ...
                <Link className={"col-12 button-menu" + (document.location.toString().search("/hangar") === -1 ? "" : "-selected")} to="/game/hangar">
                    <img className="button-menu-image" src="/website/images/hangar.jpg" alt="hangar" />
                ...
                <Link className={"col-12 button-menu" + (document.location.toString().search("/shop") === -1 ? "" : "-selected")} to="/game/shop">
                    <img className="button-menu-image" src="/website/images/shop.jpg" alt="shop" />
